...
- New env vars (all optional, see `contracts/config-env-vars.md`): `BACKEND_APP_LOG_LEVEL`, `BACKEND_ACCESS_LOG_FILE_PATH`, `BACKEND_ACCESS_LOG_MAX_SIZE_BYTES`, `BACKEND_ACCESS_LOG_MAX_FILES` — defaults are fine for local validation.
